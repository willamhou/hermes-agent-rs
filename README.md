...
- MCP bridge tools cover prompts and resources for all transports; resource subscribe/unsubscribe is currently exposed for `stdio` MCP servers, and the registry refreshes after `notifications/*/list_changed`.
